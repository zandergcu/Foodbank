jQuery(document).ready(function($){
	//if change breakpoints then update these values accordingly
	var MqM= 768,
		MqL = 1024;
	...
	//Setting "selected" class of current category
