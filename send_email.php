...
if(isset($_POST['email'])) {
    ...
    $email_to = "amacke201@caledonian.ac.uk";
    $email_subject = "New Message From Foodbank Site Visitor";
  ...
  if(strlen($message) < 2) {
    $error_message .= 'The Message you entered does appear to be valid.<br />';
  }
